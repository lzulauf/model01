...
void setup() {
  ...
  ActiveModColorEffect.setHighlightColor(CRGB(0xff, 0xff, 0xff));
  ActiveModColorEffect.setOneShotColor(CRGB(0x00, 0xff, 0xff));
  ...
  LEDDigitalRainEffect.setDecayMs(600);
  LEDDigitalRainEffect.setDropMs(200);
